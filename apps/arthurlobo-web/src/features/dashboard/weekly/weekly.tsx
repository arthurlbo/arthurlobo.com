...
import { StatsCard } from "@/features/dashboard/weekly/stats-card";

export const DashboardWeekly = () => {
    return (
        <section className="bg-surface-700/30 flex w-full flex-col items-start justify-start gap-8 rounded-2xl p-6">
            ...
            <div className="flex w-full flex-col gap-4">
                <StatsCard label="Daily Average" value="3 hrs 56 mins" period="last 7 days" icon={IconClock} />

                <div className="flex items-center justify-between gap-4">
                    <StatsCard label="Best Day" value="8 hrs 30 mins" icon={IconBolt} />
                    <StatsCard label="All Time" value="4,250 hrs 55 mins" icon={IconCalendarMonth} />
                </div>
            </div>
        </section>
    );
