    ...
    return (
        <Card link="/contact" className="flex-col items-center justify-between gap-4 p-4 lg:w-[260px]">
            ...
            <div className="relative flex h-full w-full flex-col items-center justify-center">
                ...
                <div className="border-border-400 bg-background absolute top-1/2 left-1/2 z-20 h-20 w-20 shrink-0 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-full border p-1 transition-all duration-700 ease-in-out group-hover:scale-110">
                    <Image
                        src={Me}
                        alt="Profile"
                        priority
