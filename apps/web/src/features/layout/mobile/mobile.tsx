...
export const Mobile = () => (
    <header
        ...
        className="border-surface-500 bg-background/50 fixed top-0 left-0 z-50 flex h-[72px] w-full items-center justify-between border-b p-4 backdrop-blur-sm xl:hidden"
    >
