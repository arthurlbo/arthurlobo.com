...
export const Header = () => {
    return (
        <div className="absolute left-0 top-0 flex h-[70px] w-full max-w-[100vw] items-center justify-between overflow-hidden border-b border-hover bg-transparent px-5 xl:h-[90px] xl:border-b-0 xl:px-28 xl:pb-0">
            <Link
                tabIndex={0}
                href="/"
