    ...
    return (
        <div className="flex w-full flex-col items-center gap-5 md:w-auto md:flex-row">
            <Link href={primary.link} target="_blank">
                <button className="group flex w-full animate-shimmer items-center justify-between gap-8 rounded-full border border-hover py-3 pl-9 pr-3 text-primary hover:bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] hover:bg-[length:200%_100%] md:w-auto">
            ...
            <Link href={secondary.link} target="_blank">
                <button className="flex w-full items-center justify-center gap-2 text-secondary transition-all duration-300 ease-in-out hover:text-primary md:w-auto">
