    ...
    return (
        <Dialog {...props}>
            <DialogContent className={cn("overflow-hidden p-0", className)} showCloseButton={showCloseButton}>
                ...
                <Command className="bg-background text-primary-100">{children}</Command>
            </DialogContent>
        </Dialog>
    );
}
    ...
    return (
        ...
        >
            ...
            <CommandPrimitive.Input
                ...
                className={cn(
                    "placeholder:text-primary-300 flex h-full flex-1 rounded-lg bg-transparent py-3 text-sm outline-hidden outline-0 focus:outline-0 focus:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50",
                    className,
                )}
                {...props}
            />
