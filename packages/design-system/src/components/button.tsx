    ...
    "inline-flex items-center justify-center gap-2 h-10 w-full px-4 whitespace-nowrap focus:ring-2 focus:ring-offset-2 focus:outline-none focus:ring-accent-primary/80 focus:ring-offset-background rounded-lg text-sm font-semibold transition-all duration-300 ease-in-out disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                ...
                outline: "border border-surface bg-transparent hover:bg-surface-hover text-text-primary",
